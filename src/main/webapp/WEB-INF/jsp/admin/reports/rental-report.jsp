...
<head>
    ...
    <title>Rental Report • Alpha Studio Films</title>
...
<div class="admin-wrapper">
    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <a href="/admin/reports/export/rental" class="btn-export" target="_blank">
        ...
        <div class="report-card">
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-value">${report.totalRentals}</div>
                    <div class="stat-label">Total Rentals</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value">${report.activeRentals}</div>
                    <div class="stat-label">Active</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value">${report.overdueRentals}</div>
                    <div class="stat-label">Overdue</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value">${report.returnedRentals}</div>
                    <div class="stat-label">Returned</div>
                </div>
            </div>

            <div style="text-align: center; padding: 20px; background: linear-gradient(135deg, #f8f9fa, #e9ecef); border-radius: 12px;">
                <span style="font-size: 18px; color: #1a1a2e;">Occupancy Rate: </span>
                <span style="font-size: 36px; font-weight: 700; color: #e50914;">${String.format("%.1f", report.occupancyRate)}%</span>
            </div>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [${report.activeRentals}, ${report.overdueRentals}, ${report.returnedRentals}],
