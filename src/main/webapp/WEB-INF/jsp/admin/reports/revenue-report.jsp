...
<head>
    ...
    <title>Revenue Report • Alpha Studio Films</title>
...
<div class="admin-wrapper">
    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            <h1 class="page-title">Revenue Analysis Report</h1>
            <a href="/admin/reports/export/revenue" class="btn-export" target="_blank">
        ...
        <div class="report-card">
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-value">$<fmt:formatNumber value="${report.totalRevenue}" pattern="#,##0.00"/></div>
                    <div class="stat-label">Total Revenue</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value">$<fmt:formatNumber value="${report.rentalRevenue}" pattern="#,##0.00"/></div>
                    <div class="stat-label">Rental Revenue</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value">$<fmt:formatNumber value="${report.lateFeeRevenue}" pattern="#,##0.00"/></div>
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-value" style="color: #dc3545;">$<fmt:formatNumber value="${report.refundedAmount}" pattern="#,##0.00"/></div>
                    <div class="stat-label">Refunded</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value" style="color: #e50914;">$<fmt:formatNumber value="${report.netRevenue}" pattern="#,##0.00"/></div>
                    <div class="stat-label">Net Revenue</div>
                </div>
            </div>

            <c:if test="${not empty report.topEarningMovie}">
                <div class="top-movie">
                    <i class="fas fa-trophy" style="font-size: 24px; margin-right: 10px;"></i>
                    Top Earning Movie: <strong>${report.topEarningMovie}</strong>
                    ($<fmt:formatNumber value="${report.topMovieRevenue}" pattern="#,##0.00"/>)
                </div>
            </c:if>
...
<script>
    ...
    new Chart(ctx, {
        type: 'pie',
        data: {
            labels: ['Rental Revenue', 'Late Fees', 'Refunds'],
            datasets: [{
                data: [${report.rentalRevenue}, ${report.lateFeeRevenue}, ${report.refundedAmount}],
